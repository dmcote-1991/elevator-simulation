/* East Building (4 floors, 2 elevators) */
...
const elevator2 = new Elevator(2, 4, "any"); // Elevator 2 starts idle on Floor 4
...
function trafficFlowCheck() {
  ...
  if (isMorningRush) {
    // Morning rush: Elevator 1 is set to "up" only
    console.log("Morning rush detected: Elevator 1 set to 'up' only.");
    elevator1.currentDirection = "up";
  } else if (isEveningRush) {
    // Evening rush: Elevator 2 is set to "down" only
    console.log("Evening rush detected: Elevator 2 set to 'down' only.");
